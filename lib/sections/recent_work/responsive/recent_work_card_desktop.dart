...
class DesktopRecentWorkCard extends StatefulWidget {
  // just press "Command + ."
  const DesktopRecentWorkCard({
    Key? key,
    required this.index,
  }) : super(key: key);
  ...
  @override
  _DesktopRecentWorkCardState createState() => _DesktopRecentWorkCardState();
}

class _DesktopRecentWorkCardState extends State<DesktopRecentWorkCard> {
  bool isHover = false;
