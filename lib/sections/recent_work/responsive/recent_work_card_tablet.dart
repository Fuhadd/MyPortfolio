...
class TabletRecentWorkCard extends StatefulWidget {
  // just press "Command + ."
  const TabletRecentWorkCard({
    Key? key,
    required this.index,
  }) : super(key: key);
  ...
  @override
  _TabletRecentWorkCardState createState() => _TabletRecentWorkCardState();
}

class _TabletRecentWorkCardState extends State<TabletRecentWorkCard> {
  bool isHover = false;
